...
find_library(LIBLLVM_ANALYSIS_LIBRARY NAMES LLVMAnalysis HINTS ${LLVM_LIB_DIR})
find_library(LIBLLVM_BITREADER_LIBRARY NAMES LLVMBitReader HINTS ${LLVM_LIB_DIR})
find_library(LIBLLVM_BITWRITER_LIBRARY NAMES LLVMBitWriter HINTS ${LLVM_LIB_DIR})
...
set_property(TARGET llvm::bitcode PROPERTY INTERFACE_LINK_LIBRARIES ${LIBLLVM_BITREADER_LIBRARY} ${LIBLLVM_BITWRITER_LIBRARY})
MESSAGE(${LIBLLVM_BITREADER_LIBRARY})
